...
class Wirecard_Settings {
	...
	public function show_dashboard( $start = 1 ) {
		...
		<div class="wrap">
			...
			<img src="<?php echo esc_url( plugins_url( "credit-agricole-woocommerce-extension/assets/images/credit-agricole-logo.png" ) ); ?>" width="200">
			<br/>
			<br/>
